use syn_director::apply_storylet_outcome;
...
#[test]
fn apply_storylet_outcome_applies_relationship_deltas() {
    ...
    apply_storylet_outcome(&mut world, &mut MemorySystem::new(), &storylet, &outcome, SimTick(0));
